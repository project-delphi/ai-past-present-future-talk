...
<img src="images/thinker-photo.jpg" alt="A person seated at a desk behind an openwork bronze sculpture of a head." style="height:150px;border-radius:8px;display:inline-block;vertical-align:middle;"/>
...
:::: {.columns}
::: {.column style="width:56%; font-size:0.78em;"}
- **An unstable niche** — climate, terrain, food, social order shifting faster than genomes
- Two bets: **cheap, brittle instinct**, or a **costly inference engine** — big brain, long childhood
- We took the expensive one: **work it out within a lifetime**, with no precedent to copy
- **Tools are the evidence** — an unseen cause modelled, means split from ends, a need planned for before it arrives
- Three locked-together capacities: **world-modelling, transmission, practice**
:::
::: {.column width="44%"}
<a href="https://en.wikipedia.org/wiki/Early_human_migrations" target="_blank" rel="noopener" style="text-decoration:none;"><img src="images/early-human-migration.svg" alt="World map with coloured arrows tracing early human dispersal out of Africa across Eurasia, Australia and the Americas, labelled in thousands of years ago." style="width:100%;border-radius:10px;display:block;"/></a>

<div style="text-align:center; line-height:1; margin-top:0.5em;">
<a href="https://en.wikipedia.org/wiki/Acheulean" target="_blank" rel="noopener" style="text-decoration:none;"><img src="images/acheulean-handaxe.jpg" alt="A teardrop-shaped Acheulean flint handaxe, knapped on both faces." style="height:185px;border-radius:8px;display:inline-block;"/></a>
</div>

<div style="font-size:0.3em;opacity:.55;line-height:1.3;text-align:center;margin-top:0.4em;">Out of Africa into everything — and the handaxe that went with us, barely changed for 300,000 years</div>
:::
::::

::: {.notes}
This slide answers the question Section II otherwise skips: why did *this* kind of mind evolve at all? Open with the trade-off and land the one line — instinct is a bet that tomorrow looks like today, and for us it didn't. Terrain, climate, food supply and social arrangement all moved faster than genomes could track, so the cheap compiled answer kept going stale.

Point at the map for what that bet cost us: the same animal ends up in the Arctic and the Kalahari with no specialised instinct for either, paying for a big brain and a childhood far longer than any other ape's. Then the handaxe — this is the slide's best moment, so slow down. Making one means modelling a cause you cannot see, separating means from ends, planning for a need that hasn't arrived, and carrying a technique onto unfamiliar material. Those are exactly the operations a novel problem demands, which is why a worked lump of flint counts as evidence of a mind. Say plainly that this is the standard adaptive account, not a settled one — same hedge as the Messi story.

Close by naming the three capacities and telling them to hold onto the names: world-modelling, transmission, practice. Self-supervised, supervised and reinforcement learning are their machine analogues a few slides from here, and I'll call back to this list at the Unifying View.
:::

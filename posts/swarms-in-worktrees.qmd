...
description: "Git worktrees give every agent its own working directory — turning parallel coding agents from a collision risk into a swarm."
author: "Ravi Kalia"
date: "2026-07-28"
format:
  html:
...
header-includes: |
  <style>
  h1.title, main h2 { color: #f0a868 !important; }
  main a { color: #f0a868; }
  .wt { margin: 1.6rem 0 0.4rem 0; }
  .wt svg { width: 100%; max-width: 520px; display: block; margin: 0 auto;
            font-family: ui-sans-serif, system-ui, sans-serif; }
  .wt-cap { text-align: center; font-size: 0.82rem; opacity: 0.55; margin-bottom: 1.6rem; }
  .wt-box { fill: rgba(224,108,117,0); stroke: #8b919a; stroke-width: 1.5; }
  .wt-lane { stroke: #8b919a; stroke-width: 1; stroke-dasharray: 3 4; opacity: 0.3; }
  .wt-lbl { fill: #b9bdc6; font-size: 11px; }
  .wt-tag { fill: #e6e6e9; font-size: 10px; }
  .wt-hit { fill: #e06c75; font-size: 11px; font-weight: 700; opacity: 0; }
  ...
  @keyframes wtHit  { 0%,50% { stroke: #8b919a; fill: rgba(224,108,117,0); }
                      62%    { stroke: #e06c75; fill: rgba(224,108,117,0.22); }
                      80%,100% { stroke: #8b919a; fill: rgba(224,108,117,0); } }
  ...
  @media (prefers-reduced-motion: reduce) {
    ...
    .wt-a .shared { stroke: #e06c75; fill: rgba(224,108,117,0.22); }
...
<svg viewBox="0 0 440 195" role="img" aria-label="Three agents writing into one shared working directory, where their changes collide and overwrite each other.">
  ...
  <line x1="380" y1="20" x2="380" y2="170" stroke="#8b919a" stroke-width="1.5"/>
  <circle cx="380" cy="105" r="6" fill="#8b919a"/>
  ...
  <g class="d1"><circle cx="55" cy="35"  r="8" fill="#f0a868"/></g>
  <g class="d2"><circle cx="55" cy="95"  r="8" fill="#63b3a6"/></g>
  <g class="d3"><circle cx="55" cy="155" r="8" fill="#e06c75"/></g>
</svg>
...
The same guarantee is available to subagents. Spawning one with `isolation: "worktree"` gives that subagent its own copy of the repo to work in, and the worktree is cleaned up automatically if it finishes without changing anything — so speculative work leaves no debris.
...
<svg viewBox="0 0 440 195" role="img" aria-label="Three agents each working in an isolated worktree on its own branch, in parallel without collisions, after which one branch merges into main and the others are discarded.">
  ...
  <line x1="380" y1="13" x2="380" y2="177" stroke="#8b919a" stroke-width="1.5"/>
  <circle cx="380" cy="95" r="6" fill="#8b919a"/>
  <circle class="land" cx="380" cy="95" r="8" fill="none" stroke="#63b3a6" stroke-width="2"/>
  <text class="wt-tag" x="380" y="192" text-anchor="middle">main</text>
  <g class="lose"><g class="d1"><circle cx="55" cy="35" r="8" fill="#f0a868"/></g></g>
  <g class="d2"><circle cx="55" cy="95" r="8" fill="#63b3a6"/></g>
  <g class="lose"><g class="d3"><circle cx="55" cy="155" r="8" fill="#e06c75"/></g></g>
  <g class="merge"><circle cx="300" cy="95" r="7" fill="#63b3a6"/></g>
</svg>
